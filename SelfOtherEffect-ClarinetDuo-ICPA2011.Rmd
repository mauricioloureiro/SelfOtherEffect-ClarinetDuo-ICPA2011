...
onsets <- onsets + onsets [15] - 2 * onsets [11]   # fixa o início da partitura = zero subtraindo a duração de um compasso do onset da nota 15 (nota 1 do compasso 2)
# como não tem nota no tempo 1 do compasso 1, subtrai 2 metades do compasso 1 (2* nota 11)toma a duração # su trai 
