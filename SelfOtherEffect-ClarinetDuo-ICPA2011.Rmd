...
# estima o instante zero da partitura, "onsets[0]" (início da pausa de colcheia) e subtrai d0s onsets:
# onsets[0] = onsets[15] (primeira nota do compasso 2) - duração do compasso 1
# compasso 1 = 2*(onsets[15] - onsets[11]) (compasso 1 não tem onset no início);
